...
// const for getting a new word every new day
const offsetFromDate = new Date(2022, 0, 1);
const msOffset = Date.now() - offsetFromDate;
const dayOffset = msOffset / 1000 / 60 / 60 / 24;

// const to target the index for our word of the day
const targetWord = targetWords[Math.floor(dayOffset)];

//game start
startInteraction();

// adds the dom listener for keypress / click
...
// similar to handleMouseClick, handles user input of a key, or enter / backspace / delete a tile
...
// handles the keypress of user keyboard, for input of game board, sets next tile state
...
// handles the removale of a letter
function deleteKey() {
  const activeTiles = getActiveTiles();
